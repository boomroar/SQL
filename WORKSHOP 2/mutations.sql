...
ALTER TABLE employee_categories
    ...
    ADD CONSTRAINT fk_ec_employees FOREIGN KEY (category_id) REFERENCES categories;
...
VALUES (1,2), (3,4), (4,3), (4,4), (8,1), (1,8), (1,3), (1,6)
...
INSERT INTO employees_categories(employee_id, category_id)
(
        SELECT employee_id, (SELECT categor_id FROM categories WHERE category_name = 'Dairy Products')
    FROM employees
    WHERE city = 'London'
)
